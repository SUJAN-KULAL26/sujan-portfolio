    ...
    <footer className="border-t border-slate-800 bg-[#0a0a0f]">
      <div className="section-shell flex flex-col items-center gap-4 py-10 text-center">
        <p className="text-sm text-slate-500">
          © 2026 Sujan P. Built with React & Tailwind CSS.
        </p>
          ...
          {links.map((link) => {
            ...
            return (
              <a
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-slate-800 text-slate-500 transition hover:border-indigo-500 hover:text-indigo-300"
              >
